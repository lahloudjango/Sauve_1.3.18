...
#	m.send("par-srv-cas01.eu.takasago.com", "Application_stockparis@takasagao.com", "Alpar", "Takasago!2016", starttls=True)
#	m.send(smtp="smtp.laposte.net", expediteur="Application_stockparis@takasagao.com", user="Alpar", password="Takasago!2016", starttls=True)
	m.send(smtp="smtpappsexch.firmenich.com", expediteur="SWAP@firmenich.com", user=None , password=None, starttls=False)
