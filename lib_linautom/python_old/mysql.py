...
class Mysql(object):
	...
	def open(self, mysql_host, mysql_port, mysql_user, mysql_password, charset="utf8", use_unicode=True):
		"""
...
#		print mysql_password
		...
		self.mysql_con = MySQLdb.connect(host = mysql_host, port = mysql_port, user = mysql_user, passwd = mysql_password, db = "information_schema", charset=charset, use_unicode=use_unicode )
